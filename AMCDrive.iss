...
#define MyAppName "AMCDrive X2 PlugIn"
...
Source: "domelist AMCDrive.txt";                        DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 AMCDrive.txt"
; 32 bits
Source: "libAMCDrive\Win32\Release\libAMCDrive.dll";    DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "AMCDrive.ui";                                  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
; 64 bits
Source: "libAMCDrive\x64\Release\libAMCDrive.dll";      DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "AMCDrive.ui";                                  DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
